...
4. Enter the provided edge device's serial number in the format **XXXXXXXX-XXXX-XXXX-XXXX-XXXXXXXXXXXX**.  Please make sure the serial is entered using **UPPER_CASE** characters.
